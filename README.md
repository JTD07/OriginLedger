...
After sign-in, `/app` can create an organization and project, then upload a PDF, JPEG, PNG, or WebP (25 MB maximum) to private storage. Fixture notes are in `docs/TESTING_ASSETS.md`.
